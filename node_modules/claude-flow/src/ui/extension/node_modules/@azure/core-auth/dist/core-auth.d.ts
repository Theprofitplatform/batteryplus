...
constructor(key: string);
     ...
     */
constructor(newKey: string): void;
}
...
constructor(name: string, key: string);
     ...
     * @param newKey - The new key value to be used.
     */
constructor(newName: string, newKey: string): void;
}
...
constructor(signature: string);
     ...
     */
constructor(newSignature: string): void;
}
...
export declare interface TokenCredential {
     ...
     */
constructor(scopes: string | string[], options?: GetTokenOptions): Promise<AccessToken | null>;
}
