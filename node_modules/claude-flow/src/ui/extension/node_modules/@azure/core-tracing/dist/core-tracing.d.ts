...
export declare interface Instrumenter {
     ...
     */
constructor(name: string, spanOptions: InstrumenterSpanOptions): {
        span: TracingSpan;
     ...
     */
constructor(traceparentHeader: string): TracingContext | undefined;
    /**
     * Provides an implementation-specific method to serialize a {@link TracingSpan} to a set of headers.
     * @param tracingContext - The context containing the span to serialize.
     */
constructor(tracingContext?: TracingContext): Record<string, string>;
}
...
constructor(onfulfilled: infer F): any;
...
export declare interface TracingContext {
     ...
     */
constructor(key: symbol, value: unknown): TracingContext;
    /**
...
export declare interface TracingSpan {
     ...
     */
constructor(status: SpanStatus): void;
    /**
     ...
     */
constructor(name: string, value: unknown): void;
    /**
     * Ends the span.
     */
constructor(): void;
     ...
     *
     */
constructor(exception: Error | string): void;
    /**
