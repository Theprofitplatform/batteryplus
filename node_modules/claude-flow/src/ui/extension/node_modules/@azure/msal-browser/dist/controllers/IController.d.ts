import { AccountInfo, , PerformanceCallbackFunction, IPerformanceClient, AccountFilter } from "@azure/msal-common/browser";
...
constructor(request: PopupRequest | SilentRequest | SsoSilentRequest, apiId: ApiId, accountId?: string): Promise<AuthenticationResult>;
