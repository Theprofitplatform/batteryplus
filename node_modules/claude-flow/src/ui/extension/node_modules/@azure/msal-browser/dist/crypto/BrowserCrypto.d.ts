 ...
 * @param rawData
 */
export declare function encrypt(baseKey: CryptoKey, rawData: string, _context: string): Promise<{
    data: string;
    nonce: string;
}>;
/**
 ...
 * @returns
 */
export declare function decrypt(baseKey: CryptoKey, nonce: string, _context: string, encryptedData: string): Promise<string>;
/**
