...
constructor(): string;
     ...
     */
constructor(measureName: string, correlationId?: string): InProgressPerformanceEvent;
    /**
     ...
     * @returns
     */
constructor(eventName: PerformanceEvents, correlationId?: string): void;
    /**
     ...
     * @returns
     */
constructor(eventName: string, correlationId?: string, queueTime?: number, manuallyCompleted?: boolean): void;
}
