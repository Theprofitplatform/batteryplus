...
import { AccountInfo, INetworkModule, , CommonSilentFlowRequest, ICrypto, PerformanceCallbackFunction, IPerformanceClient, BaseAuthRequest, AccountFilter } from "@azure/msal-common/browser";
...
constructor(request: AuthorizationCodeRequest): Promise<AuthenticationResult>;
     ...
     * @returns A promise that, when resolved, returns the access token
     */
constructor(commonRequest: CommonSilentFlowRequest, cacheLookupPolicy: CacheLookupPolicy): Promise<AuthenticationResult>;
    /**
...
constructor(result: AuthenticationResult, request: SilentRequest | SsoSilentRequest | RedirectRequest | PopupRequest): Promise<void>;
     ...
     * @param request
     */
constructor(request: PopupRequest | SilentRequest | SsoSilentRequest, apiId: ApiId, accountId?: string, cacheLookupPolicy?: CacheLookupPolicy): Promise<AuthenticationResult>;
    /**
     * Returns boolean indicating if this request can use the platform broker
     * @param request
     */
constructor(request: RedirectRequest | PopupRequest | SsoSilentRequest, accountId?: string): boolean;
    /**
     * Get the native accountId from the account
     * @param request
     * @returns
     */
constructor(request: RedirectRequest | PopupRequest | SsoSilentRequest): string;
    /**
     * Returns new instance of the Popup Interaction Client
     * @param correlationId
     */
constructor(correlationId?: string): PopupClient;
    /**
     ...
     * @param correlationId
     */
constructor(correlationId?: string): SilentIframeClient;
    /**
...
constructor(request?: PopupRequest): Promise<AuthenticationResult>;
     ...
     */
constructor(request: SilentRequest): Promise<AuthenticationResult>;
    /**
