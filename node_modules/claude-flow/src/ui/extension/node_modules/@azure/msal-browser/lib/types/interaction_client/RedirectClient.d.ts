import { ServerTelemetryManager, AuthorizeResponse, ICrypto, , IPerformanceClient, InProgressPerformanceEvent, CommonAuthorizationUrlRequest } from "@azure/msal-common/browser";
...
constructor(request: RedirectRequest): Promise<void>;
     ...
     * @returns
     */
constructor(request: CommonAuthorizationUrlRequest, onRedirectNavigate?: (url: string) => boolean | void): Promise<void>;
    /**
     * Executes EAR flow
     * @param request
     */
constructor(request: CommonAuthorizationUrlRequest): Promise<void>;
    /**
     ...
     */
constructor(hash: string | undefined, request: CommonAuthorizationUrlRequest, pkceVerifier: string, parentMeasurement: InProgressPerformanceEvent): Promise<AuthenticationResult | null>;
    /**
     ...
     */
constructor(requestUrl: string, onRedirectNavigateRequest?: (url: string) => boolean | void): Promise<void>;
    /**
