import { ICrypto, , AuthorizationCodeClient, IPerformanceClient, CommonAuthorizationUrlRequest } from "@azure/msal-common/browser";
...
constructor(request: SsoSilentRequest): Promise<AuthenticationResult>;
     ...
     * @returns
     */
constructor(request: CommonAuthorizationUrlRequest): Promise<AuthenticationResult>;
    /**
     * Executes EAR flow
     * @param request
     */
