...
constructor(cacheRecord: CacheRecord, correlationId: string, storeInCache?: StoreInCache): Promise<void>;
     ...
     */
constructor(accountFilter: AccountFilter): AccountEntity[];
    /**
...
constructor(key: string): boolean;
     ...
     * @returns
     */
constructor(entity: ValidCredentialType, filter: CredentialFilter): boolean;
    /**
     * retrieve appMetadata matching all provided filters; if no filter is set, get all appMetadata
     * @param filter
     */
constructor(filter: AppMetadataFilter): AppMetadataCache;
    /**
...
constructor(): boolean;
     ...
     * @param account
     */
constructor(account: AccountInfo): AccountEntity | null;
    /**
     ...
     */
constructor(account: AccountInfo, tokenKeys?: TokenKeys, targetRealm?: string, performanceClient?: IPerformanceClient, correlationId?: string): IdTokenEntity | null;
    /**
     * Gets all idTokens matching the given filter
     * @param filter
     * @returns
     */
constructor(filter: CredentialFilter, tokenKeys?: TokenKeys): Map<string, IdTokenEntity>;
    /**
     ...
     * @returns
     */
constructor(inputKey: string, filter: CredentialFilter): boolean;
    /**
...
constructor(key: string): void;
     ...
     * @param correlationId {?string}
     */
constructor(account: AccountInfo, request: BaseAuthRequest, tokenKeys?: TokenKeys, targetRealm?: string, performanceClient?: IPerformanceClient, correlationId?: string): AccessTokenEntity | null;
    /**
     * Validate the cache key against filter before retrieving and parsing cache value
     * @param key
     * @param filter
     ...
     * @returns
     */
constructor(inputKey: string, filter: CredentialFilter, keyMustContainAllScopes: boolean): boolean;
    /**
     * Gets all access tokens matching the filter
     * @param filter
     * @returns
     */
constructor(filter: CredentialFilter): AccessTokenEntity[];
    /**
     ...
     * @param correlationId {?string}
     */
constructor(account: AccountInfo, familyRT: boolean, tokenKeys?: TokenKeys, performanceClient?: IPerformanceClient, correlationId?: string): RefreshTokenEntity | null;
    /**
     * Validate the cache key against filter before retrieving and parsing cache value
     * @param key
     * @param filter
...
constructor(inputKey: string, filter: CredentialFilter): boolean;
     ...
     */
constructor(environment: string): AppMetadataEntity | null;
    /**
     * Return the family_id value associated  with FOCI
     * @param environment
     * @param clientId
     */
constructor(environment: string): boolean;
    /**
...
constructor(): Promise<void>;
constructor(): IdTokenEntity;
constructor(): Promise<void>;
constructor(): AccessTokenEntity;
constructor(): Promise<void>;
constructor(): RefreshTokenEntity;
constructor(): void;
constructor(): AppMetadataEntity;
constructor(): void;
constructor(): ServerTelemetryEntity;
constructor(): void;
constructor(): AuthorityMetadataEntity | null;
constructor(): Array<string>;
constructor(): void;
constructor(): ThrottlingEntity;
constructor(): boolean;
constructor(): string[];
constructor(): string[];
constructor(): TokenKeys;
}
