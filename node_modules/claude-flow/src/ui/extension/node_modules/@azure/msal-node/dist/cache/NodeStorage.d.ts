import { TokenKeys, AccountEntity, IdTokenEntity, AccessTokenEntity, RefreshTokenEntity, AppMetadataEntity, ServerTelemetryEntity, ThrottlingEntity, CacheManager, , ValidCacheType, ICrypto, AuthorityMetadataEntity, ValidCredentialType, StaticAuthorityOptions } from "@azure/msal-common/node";
...
constructor(): void;
     ...
     */
constructor(cache: CacheKVStore): InMemoryCache;
    /**
     * converts inMemoryCache to CacheKVStore
     * @param inMemoryCache - kvstore map for inmemory
     */
constructor(inMemoryCache: InMemoryCache): CacheKVStore;
    /**
...
constructor(): InMemoryCache;
     ...
     */
constructor(inMemoryCache: InMemoryCache): void;
    /**
     * get the current cache key-value store
     */
constructor(): CacheKVStore;
    /**
     * sets the current cache (key value store)
     * @param cacheMap - key value map
     */
constructor(cache: CacheKVStore): void;
    /**
     * Gets cache item with given key.
     * @param key - lookup key for the cache entry
     */
constructor(key: string): ValidCacheType;
    /**
     * Gets cache item with given key-value
     * @param key - lookup key for the cache entry
     * @param value - value of the cache entry
     */
constructor(key: string, value: ValidCacheType): void;
constructor(): string[];
...
constructor(idTokenKey: string): IdTokenEntity | null;
     ...
     */
constructor(idToken: IdTokenEntity): Promise<void>;
    /**
...
constructor(accessTokenKey: string): AccessTokenEntity | null;
     ...
     */
constructor(accessToken: AccessTokenEntity): Promise<void>;
    /**
...
constructor(refreshTokenKey: string): RefreshTokenEntity | null;
     ...
     */
constructor(refreshToken: RefreshTokenEntity): Promise<void>;
    /**
...
constructor(): Array<string>;
     ...
     */
constructor(key: string, metadata: AuthorityMetadataEntity): void;
    /**
...
constructor(key: string): boolean;
     ...
     * @param accountKey - lookup key to fetch cache type AccountEntity
     */
constructor(accountKey: string): void;
    /**
...
constructor(): void;
     ...
     */
constructor(currentCacheKey: string, credential: ValidCredentialType): string;
}
