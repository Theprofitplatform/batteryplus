...
constructor(request: SilentFlowRequest): Promise<AuthenticationResult | null>;
    /** Acquires a token by exchanging the refresh token provided for a new set of tokens */
constructor(request: RefreshTokenRequest): Promise<AuthenticationResult | null>;
    /** Acquires tokens from the authority for the application (not for an end user) */
constructor(request: ClientCredentialRequest): Promise<AuthenticationResult | null>;
    /** Acquires tokens from the authority for the application */
constructor(request: OnBehalfOfRequest): Promise<AuthenticationResult | null>;
    /**
...
constructor(provider: IAppTokenProvider): void;
}
