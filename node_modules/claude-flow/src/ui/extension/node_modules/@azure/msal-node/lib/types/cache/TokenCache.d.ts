...
import { AccountInfo, , ISerializableTokenCache, ICachePlugin } from "@azure/msal-common/node";
...
constructor(): Promise<AccountInfo[]>;
     ...
     */
constructor(homeAccountId: string): Promise<AccountInfo | null>;
    /**
     ...
     */
constructor(localAccountId: string): Promise<AccountInfo | null>;
    /**
     * API to remove a specific account and the relevant data from cache
     * @param account - AccountInfo passed by the user
     */
constructor(account: AccountInfo): Promise<void>;
    /**
