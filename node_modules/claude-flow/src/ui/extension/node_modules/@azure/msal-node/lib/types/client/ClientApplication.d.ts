import { ClientConfiguration, AuthenticationResult, Authority, BaseAuthRequest, , ServerTelemetryManager, AzureRegionConfiguration, AzureCloudOptions, AuthorizationCodePayload, ClientAssertionCallback } from "@azure/msal-common/node";
...
constructor(request: AuthorizationUrlRequest): Promise<string>;
     ...
     */
constructor(request: AuthorizationCodeRequest, authCodePayLoad?: AuthorizationCodePayload): Promise<AuthenticationResult>;
    /**
