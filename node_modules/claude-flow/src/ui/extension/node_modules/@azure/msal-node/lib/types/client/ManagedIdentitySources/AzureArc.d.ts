import { INetworkModule, NetworkResponse, NetworkRequestOptions, , ServerAuthorizationTokenResponse } from "@azure/msal-common/node";
...
constructor(resource: string): ManagedIdentityRequestParameters;
constructor(originalResponse: NetworkResponse<ManagedIdentityTokenResponse>, networkClient: INetworkModule, networkRequest: ManagedIdentityRequestParameters, networkRequestOptions: NetworkRequestOptions): Promise<ServerAuthorizationTokenResponse>;
}
export {};
