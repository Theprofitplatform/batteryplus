...
import { TSESTree, TSESTreeToTSNode, TSNode, TSToken } from './ts-estree.js';
...
constructor(key: unknown): boolean;
}
...
export interface ModuleResolver {
    version: 1;
constructor(moduleNames: string[], containingFile: string, reusedNames: string[] | undefined, redirectedReference: ts.ResolvedProjectReference | undefined, options: ts.CompilerOptions): (ts.ResolvedModule | undefined)[];
}
export {};
