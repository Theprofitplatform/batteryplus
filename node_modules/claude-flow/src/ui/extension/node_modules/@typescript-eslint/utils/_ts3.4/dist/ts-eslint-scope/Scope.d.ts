...
import { Reference, ReferenceFlag } from './Reference.js';
...
interface Scope {
    ...
    __left: Reference[];
constructor(scopeManager: ScopeManager): boolean;
constructor(ref: any): boolean;
constructor(ref: any): void;
constructor(ref: any): void;
constructor(ref: any): void;
constructor(scopeManager: ScopeManager): Scope;
constructor(ref: any, variable: any): variable is Variable;
constructor(ref: Reference): boolean;
constructor(ref: any): void;
constructor(variable: any, node: TSESTree.Node): void;
constructor(name: string, set: Map<string, Variable>, variables: Variable[], node: TSESTree.Identifier, def: Definition): void;
constructor(node: TSESTree.Node, def: Definition): void;
constructor(node: TSESTree.Node, assign?: ReferenceFlag, writeExpr?: TSESTree.Node, maybeImplicitGlobal?: any, partial?: any, init?: any): void;
constructor(): void;
constructor(): void;
constructor(): boolean;
    /**
     ...
     */
constructor(ident: TSESTree.Node): Reference;
    /**
