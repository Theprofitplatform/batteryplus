...
import { RuleListener, RuleMetaData, RuleModule } from './Rule.js';
...
constructor(patterns: string[]): CLIEngine.LintReport;
         ...
         */
constructor(text: string, filename?: string, warnIgnored?: boolean): CLIEngine.LintReport;
        /**
         ...
         */
constructor(filePath: string): Linter.Config;
        /**
         ...
         */
constructor(format?: string): CLIEngine.Formatter;
        /**
...
constructor(patterns: string[]): string[];
     ...
     */
constructor(results: CLIEngine.LintResult[]): CLIEngine.LintResult[];
    /**
...
constructor(format?: string): CLIEngine.Formatter;
     ...
     */
constructor(report: CLIEngine.LintReport): void;
    version: string;
} | undefined;
export { CLIEngine };
