...
constructor(options?: ESLint.ESLintOptions);
     ...
     */
constructor(filePath: string): Promise<Linter.Config>;
    /**
     ...
     *          it will return true.
     */
constructor(filePath: string): Promise<boolean>;
    /**
     ...
     */
constructor(patterns: string | string[]): Promise<ESLint.LintResult[]>;
    /**
     ...
     *          method similar.
     */
constructor(code: string, options?: ESLint.LintTextOptions): Promise<ESLint.LintResult[]>;
    /**
     ...
     */
constructor(name?: string): Promise<ESLint.Formatter>;
    /**
...
declare namespace ESLint {
    ...
    interface Formatter {
         ...
         */
constructor(results: LintResult[]): string | Promise<string>;
    }
}
