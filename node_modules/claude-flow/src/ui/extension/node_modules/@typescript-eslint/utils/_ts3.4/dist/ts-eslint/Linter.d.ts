import { ParserServices, TSESTree } from '../ts-estree.js';
import { ParserOptions as TSParserOptions } from './ParserOptions.js';
import { RuleCreateFunction, RuleFix, RuleModule, SharedConfigurationSettings } from './Rule.js';
...
constructor(config?: Linter.LinterOptions);
     ...
     */
constructor(parserId: string, parserModule: Linter.ParserModule): void;
    /**
     ...
     */
constructor(): Map<string, RuleModule<string, unknown[]>>;
    /**
...
constructor(): SourceCode;
     ...
     */
constructor(textOrSourceCode: SourceCode | string, config: Linter.Config, filenameOrOptions?: string | Linter.VerifyOptions): Linter.LintMessage[];
    /**
     ...
     */
constructor(code: string, config: Linter.Config, options: Linter.FixOptions): Linter.FixReport;
    /**
...
constructor(text: string, options?: ParserOptions): TSESTree.Program;
    } | {
constructor(text: string, options?: ParserOptions): ESLintParseResult;
    };
