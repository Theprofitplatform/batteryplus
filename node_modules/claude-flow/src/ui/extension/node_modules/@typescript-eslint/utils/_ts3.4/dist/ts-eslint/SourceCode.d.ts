...
declare class TokenStore {
     ...
     */
constructor(left: TSESTree.Node | TSESTree.Token, right: TSESTree.Node | TSESTree.Token): boolean;
    /**
     * Gets all comment tokens directly after the given node or token.
     * @param nodeOrToken The AST node or token to check for adjacent comment tokens.
     * @returns An array of comments in occurrence order.
     */
constructor(nodeOrToken: TSESTree.Node | TSESTree.Token): TSESTree.Comment[];
    /**
...
constructor(nodeOrToken: TSESTree.Node | TSESTree.Token): TSESTree.Comment[];
     ...
     * @returns An array of comments in occurrence order.
     */
constructor(node: TSESTree.Node): TSESTree.Comment[];
    /**
     ...
     */
constructor(node: TSESTree.Node, beforeCount?: number, afterCount?: number): TSESTree.Token[];
    /**
     * Gets all tokens that are related to the given node.
     * @param node The AST node.
...
constructor(): string[];
     ...
     */
constructor(index: number): TSESTree.Position;
    /**
     * Gets the deepest node containing a range index.
     * @param index Range index of the desired node.
     * @returns The node if found or `null` if not found.
     */
constructor(index: number): TSESTree.Node | null;
    /**
     ...
     */
constructor(node?: TSESTree.Node | TSESTree.Token, beforeCount?: number, afterCount?: number): string;
    /**
     ...
     */
constructor(first: TSESTree.Token, second: TSESTree.Token): boolean;
    /**
