...
constructor(type: string, apiVersion?: string): string;
constructor(type: string, apiVersion?: string): rm.IRequestOptions;
constructor(data: any, responseTypeMetadata: any, isCollection: boolean): any;
}
