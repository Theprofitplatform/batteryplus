...
constructor(configuration: PolicyInterfaces.PolicyConfiguration, project: string): Promise<PolicyInterfaces.PolicyConfiguration>;
constructor(project: string, configurationId: number): Promise<void>;
constructor(project: string, configurationId: number): Promise<PolicyInterfaces.PolicyConfiguration>;
constructor(project: string, scope?: string, policyType?: string): Promise<VSSInterfaces.PagedList<PolicyInterfaces.PolicyConfiguration>>;
constructor(configuration: PolicyInterfaces.PolicyConfiguration, project: string, configurationId: number): Promise<PolicyInterfaces.PolicyConfiguration>;
constructor(project: string, evaluationId: string): Promise<PolicyInterfaces.PolicyEvaluationRecord>;
constructor(project: string, evaluationId: string): Promise<PolicyInterfaces.PolicyEvaluationRecord>;
constructor(project: string, artifactId: string, includeNotApplicable?: boolean, top?: number, skip?: number): Promise<PolicyInterfaces.PolicyEvaluationRecord[]>;
constructor(project: string, configurationId: number, revisionId: number): Promise<PolicyInterfaces.PolicyConfiguration>;
constructor(project: string, configurationId: number, top?: number, skip?: number): Promise<PolicyInterfaces.PolicyConfiguration[]>;
constructor(project: string, typeId: string): Promise<PolicyInterfaces.PolicyType>;
constructor(project: string): Promise<PolicyInterfaces.PolicyType[]>;
}
