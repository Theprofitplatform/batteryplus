...
constructor(baseUrl: string, restClient: restm.RestClient);
     ...
     */
constructor(apiVersion: string, area: string, locationId: string, routeValues: any, queryParams?: any): Promise<ClientVersioningData>;
    /**
     * Sets a promise that is waited on before any requests are issued. Can be used to asynchronously
     * set the request url and auth token manager.
     */
constructor(promise: Promise<any>): void;
    /**
     ...
     */
constructor(area: string, locationId: string): Promise<ifm.ApiResourceLocation | undefined>;
    private beginGetAreaLocations;
constructor(relativeUrl: string): string;
