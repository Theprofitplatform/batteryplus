...
export declare interface AbortSignal {
     ...
     */
constructor(type: 'abort', listener: () => void): void;
    /**
...
constructor(): void;
     ...
     */
constructor(chunk: ArrayBufferView): void;
    /**
...
constructor(underlyingSource?: UnderlyingSource<R>, strategy?: QueuingStrategy<R>);
    ...
    */
     ...
     */
constructor(reason?: any): Promise<void>;
    /**
...
constructor({ mode }: {
     ...
     */
constructor(): ReadableStreamDefaultReader<R>;
    /**
     ...
     * Piping a stream will lock it for the duration of the pipe, preventing any other consumer from acquiring a reader.
     */
constructor(destination: WritableStream<R>, options?: StreamPipeOptions): Promise<void>;
    /**
...
constructor(): [
     ...
     */
constructor(options?: ReadableStreamIteratorOptions): ReadableStreamAsyncIterator<R>;
    /**
...
constructor(): Promise<IteratorResult<R>>;
constructor(value?: any): Promise<IteratorResult<any>>;
}
/**
...
export declare class ReadableStreamBYOBRequest {
    ...
    */
     ...
     * modifiable.
     */
constructor(bytesWritten: number): void;
    /**
     ...
     */
constructor(view: ArrayBufferView): void;
}
/**
...
constructor(reason?: any): Promise<void>;
     ...
     * If reading a chunk causes the queue to become empty, more data will be pulled from the underlying source.
     */
constructor(): Promise<ReadableStreamDefaultReadResult<R>>;
    /**
     * Releases the reader's lock on the corresponding stream. After the lock is released, the reader is no longer active.
     * If the associated stream is errored when the lock is released, the reader will appear errored in the same way
     * from now on; otherwise, the reader will appear closed.
...
export declare interface ReadableStreamLike<R = any> {
    readonly locked: boolean;
constructor(): ReadableStreamDefaultReaderLike<R>;
}
/**
...
export declare class TransformStreamDefaultController<O> {
    ...
    */
     ...
     */
constructor(chunk: O): void;
    /**
     * Errors both the readable side and the writable side of the controlled transform stream, making all future
     * interactions with it fail with the given error `e`. Any chunks queued for transformation will be discarded.
     */
constructor(reason?: any): void;
    /**
...
constructor(): Promise<undefined>;
     ...
     */
constructor(): WritableStreamDefaultWriter<W>;
}
/**
...
constructor(): void;
     ...
     */
constructor(chunk: W): Promise<void>;
}
export {};
